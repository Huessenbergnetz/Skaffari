 ...
 * \brief Cutelee template filter to sort a list of strings according to the current locale.
 *
 * This filter can be used as \c sk_stringlistsort in your Cutelee templates. It sorts a list
 * of strings accodring to the current locale.
 */
class StringListSortFilter : public Cutelee::Filter // clazy:exclude=copyable-polymorphic
{
public:
