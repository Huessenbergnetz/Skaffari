...
/*!
 * \internal
 * \brief Cutelee node factory for the FileSizeFormat tag.
 */
class FileSizeFormatTag : public Cutelee::AbstractNodeFactory
{
    Q_OBJECT
public:
    /*!
 ...
 * \brief Cutelee template tag to convert a numeric value into a human readable file size.
 *
 ...
 *
 * The tag can be used as \c sk_fsf in your Cutelee templates. It accepts up to 4 parameters.
 ...
 * \endcode
 */
class FileSizeFormat : public Cutelee::Node // clazy:exclude=ctor-missing-parent-argument
{
    Q_OBJECT
public:
    /*!
     ...
     */
    explicit FileSizeFormat(const Cutelee::FilterExpression &size, const Cutelee::FilterExpression &base, const Cutelee::FilterExpression &decimal, const Cutelee::FilterExpression &multiplier, Cutelee::Parser *parser = nullptr);
...
private:
    ...
    Cutelee::FilterExpression m_size;
    Cutelee::FilterExpression m_base;
    Cutelee::FilterExpression m_precision;
    Cutelee::FilterExpression m_multiplier;
