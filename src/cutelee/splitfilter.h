 ...
 * \brief Cutelee template filter to split a string into QStringList.
 *
 * This filter can be use as \c sk_split in your cutelee templates. It splits
 ...
 * \endcode
 */
class SplitFilter : public Cutelee::Filter // clazy:exclude=copyable-polymorphic
{
public:
