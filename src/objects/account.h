...
public:
    ...
    static Account create(Cutelyst::Context *c, SkaffariError *e, const Cutelyst::ParamsMultiMap &p, const Domain &d, quint8 pwType, quint8 pwMethod, quint32 pwRounds, bool domainAsPrefix, bool fqun, CreateMailbox createMailbox, const QVariantMap imapConfig = QVariantMap());
